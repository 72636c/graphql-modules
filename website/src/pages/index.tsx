...
export default function Index() {
    return (
        <>
            ...
            <HeroIllustration flipped title={<>
                <div className="_title">
                    <span>Integrates with your</span>
                    <div className="apollo-text">
                        <img src={'/assets/img/home/companies/apollo-logo.png'} className="_apollo-logo"/>
                        <span>server</span>
                    </div>
                </div>
            </>}
                              ...
                              image={{src: '/assets/img/home/workers-full.svg', alt: 'workers', loading: 'lazy'}}/>
        </>
    );
}
